...
const D = {
  ...
  /* newsletter (footer) — Faza 2 */
  nl_title:    { ro: "Prinde datele libere primul", en: "Be first to catch free dates", he: "היו הראשונים לתפוס תאריכים פנויים", fr: "Soyez le premier informé des dates libres" },
  nl_sub:      { ro: "Vilele sunt des pline. Îți scriem când se eliberează date și la ofertele early-bird.", en: "The villas fill up fast. We'll email you when dates open up and for early-bird offers.", he: "הווילות מתמלאות מהר. נעדכן אותך כשמתפנים תאריכים ובמבצעים מוקדמים.", fr: "Les villas se remplissent vite. Nous vous écrirons dès que des dates se libèrent et pour les offres early-bird." },
  nl_email:    { ro: "Emailul tău", en: "Your email", he: "האימייל שלך", fr: "Votre e-mail" },
  nl_consent:  { ro: "Sunt de acord să primesc pe email oferte și disponibilități ROOTS (mă pot dezabona oricând).", en: "I agree to receive ROOTS offers and availability by email (I can unsubscribe anytime).", he: "אני מסכים/ה לקבל מבצעים וזמינות של ROOTS במייל (אפשר לבטל בכל עת).", fr: "J'accepte de recevoir par e-mail les offres et disponibilités ROOTS (désabonnement à tout moment)." },
  nl_submit:   { ro: "Abonează-mă", en: "Subscribe", he: "הרשמה", fr: "S'abonner" },
  nl_sending:  { ro: "Se trimite…", en: "Sending…", he: "שולח…", fr: "Envoi…" },
  nl_ok:       { ro: "Aproape gata — verifică-ți emailul și confirmă abonarea ✓", en: "Almost there — check your inbox and confirm ✓", he: "כמעט — בדוק/י את המייל ואשר/י ✓", fr: "Presque — vérifiez votre boîte et confirmez ✓" },
  nl_err:      { ro: "Ceva n-a mers. Încearcă din nou.", en: "Something went wrong. Try again.", he: "משהו השתבש. נסה/י שוב.", fr: "Une erreur est survenue. Réessayez." },
  /* „anunță-mă când se eliberează" (calendar) */
  notify_cta:  { ro: "Datele dorite sunt ocupate? Anunță-mă când se eliberează", en: "Dates you want are taken? Notify me when they free up", he: "התאריכים שרצית תפוסים? עדכנו אותי כשיתפנו", fr: "Vos dates sont prises ? Prévenez-moi quand elles se libèrent" },
  notify_title:{ ro: "Te anunțăm când se eliberează", en: "We'll let you know when it opens up", he: "נעדכן אותך כשיתפנה", fr: "Nous vous préviendrons dès que c'est libre" },
  notify_dates:{ ro: "Perioada dorită (opțional)", en: "Desired dates (optional)", he: "התאריכים הרצויים (רשות)", fr: "Dates souhaitées (facultatif)" },
  notify_ok:   { ro: "Gata — verifică-ți emailul și confirmă ✓", en: "Done — check your inbox and confirm ✓", he: "מצוין — בדוק/י את המייל ואשר/י ✓", fr: "C'est fait — vérifiez votre boîte et confirmez ✓" },
